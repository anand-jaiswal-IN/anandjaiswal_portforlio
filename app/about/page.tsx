...
import { HiDownload, HiMail, HiLocationMarker, HiCalendar, HiCode, HiUsers } from "react-icons/hi"
...
const education = [
  {
    ...
    period: "2019 - 2023",
    description: "Graduated with First Class Honors, specializing in Software Engineering and Data Structures. Completed coursework in Advanced Algorithms, Database Systems, Machine Learning, and Web Technologies.",
    achievements: [
  ...
  },
  {
    ...
    location: "Delhi, India", 
    period: "2017 - 2019",
    description: "Completed 12th grade with focus on Mathematics, Physics, and Computer Science. Achieved 95% marks and was among the top 5% of students.",
    achievements: [
...
const experience = [
  {
    ...
    period: "2023 - Present",
    current: true,
    description: "Leading development of enterprise web applications using React, Next.js, and Node.js. Managing a team of 4 developers and collaborating with cross-functional teams to deliver high-quality software solutions.",
    achievements: [
  ...
  },
  {
    ...
    period: "2022 - 2023",
    description: "Developed and maintained multiple client projects using modern web technologies. Worked closely with designers and product managers to create user-friendly applications.",
    achievements: [
  ...
  },
  {
    ...
    location: "Delhi, India",
    period: "2021 - 2022",
    description: "Gained hands-on experience in frontend development, working on various client projects and learning industry best practices.",
    achievements: [
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-foreground-muted leading-relaxed">
                <p>
                  Hello! I'm Anand Jaiswal, a passionate full-stack developer with over 3 years of experience 
                  creating digital solutions that make a difference. My journey in technology started during 
                  my college years when I discovered the power of code to solve real-world problems.
                </p>
                
                <p>
                  What drives me is the intersection of technology and creativity. I believe that great software 
                  is not just about functionality—it's about creating experiences that delight users and solve 
                  meaningful problems. This philosophy guides every project I work on.
                </p>
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-accent/20 rounded-full blur-xl animate-pulse" style={{ animationDelay: "1s" }} />
              </motion.div>
            </div>
          </div>
        </motion.div>
